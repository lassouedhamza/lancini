                    ...
                    <div className="row ">
                      ...
                      <div className="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div className="banner-img">
                          <img src="assets22/img/banner/1.png" alt=""/>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="card-statistic-4">
                  <div className="align-items-center justify-content-between">
                    <div className="row ">
                      ...
                      <div className="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div className="banner-img">
                          <img src="assets2/img/banner/2.png" alt=""/>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="card-statistic-4">
                  <div className="align-items-center justify-content-between">
                    <div className="row ">
                      ...
                      <div className="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div className="banner-img">
                          <img src="assets2/img/banner/3.png" alt=""/>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="card-statistic-4">
                  <div className="align-items-center justify-content-between">
                    <div className="row ">
                      ...
                      <div className="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div className="banner-img">
                          <img src="assets2/img/banner/4.png" alt=""/>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <table className="table table-striped">
                        ...
                        <td className="text-truncate">
                          <ul className="list-unstyled order-list m-b-0 m-b-0">
                            <li className="team-member team-member-sm"><img className="rounded-circle"
                                src="assets2/img/users/user-8.png" alt="user" data-toggle="tooltip" title=""
                                data-original-title="Wildan Ahdian"/></li>
                            <li className="team-member team-member-sm"><img className="rounded-circle"
                                src="assets2/img/users/user-9.png" alt="user" data-toggle="tooltip" title=""
                                data-original-title="John Deo"/></li>
                            <li className="team-member team-member-sm"><img className="rounded-circle"
                                src="assets2/img/users/user-10.png" alt="user" data-toggle="tooltip" title=""
                      ...
                      <tr>
                        ...
                        <td className="text-truncate">
                          <ul className="list-unstyled order-list m-b-0 m-b-0">
                            <li className="team-member team-member-sm"><img className="rounded-circle"
                                src="assets2/img/users/user-1.png" alt="user" data-toggle="tooltip" title=""
                                data-original-title="Wildan Ahdian"/></li>
                            <li className="team-member team-member-sm"><img className="rounded-circle"
                                src="assets2/img/users/user-2.png" alt="user" data-toggle="tooltip" title=""
                                data-original-title="John Deo"/></li>
                      ...
                      <tr>
                        ...
                        <td className="text-truncate">
                          <ul className="list-unstyled order-list m-b-0 m-b-0">
                            <li className="team-member team-member-sm"><img className="rounded-circle"
                                src="assets2/img/users/user-3.png" alt="user" data-toggle="tooltip" title=""
                                data-original-title="Wildan Ahdian"/></li>
                            <li className="team-member team-member-sm"><img className="rounded-circle"
                                src="assets2/img/users/user-4.png" alt="user" data-toggle="tooltip" title=""
                                data-original-title="John Deo"/></li>
                            <li className="team-member team-member-sm"><img className="rounded-circle"
                                src="assets2/img/users/user-5.png" alt="user" data-toggle="tooltip" title=""
                                data-original-title="Sarah Smith"/></li>
                      ...
                      <tr>
                        ...
                        <td className="text-truncate">
                          <ul className="list-unstyled order-list m-b-0 m-b-0">
                            <li className="team-member team-member-sm"><img className="rounded-circle"
                                src="assets2/img/users/user-7.png" alt="user" data-toggle="tooltip" title=""
                                data-original-title="John Deo"/></li>
                            <li className="team-member team-member-sm"><img className="rounded-circle"
                                src="assets2/img/users/user-8.png" alt="user" data-toggle="tooltip" title=""
                                data-original-title="Sarah Smith"/></li>
              ...
              <div className="card">
                ...
                <div className="card-body">
                  <div className="support-ticket media pb-1 mb-3">
                    <img src="assets2/img/users/user-1.png" className="user-img mr-2" alt=""/>
                  ...
                  <div className="support-ticket media pb-1 mb-3">
                    <img src="assets2/img/users/user-2.png" className="user-img mr-2" alt=""/>
                    <div className="media-body ml-3">
                  ...
                  <div className="support-ticket media pb-1 mb-3">
                    <img src="assets2/img/users/user-3.png" className="user-img mr-2" alt=""/>
                    <div className="media-body ml-3">
                  ...
                  <div className="support-ticket media pb-1 mb-3">
                    <img src="assets2/img/users/user-6.png" className="user-img mr-2" alt=""/>
                    <div className="media-body ml-3">
