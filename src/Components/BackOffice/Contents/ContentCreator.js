...
const ContentCreator = () => {
 ...
 const getInvestors = async ()=> {
     const response=await axios.get("https://codeveloperslancini.herokuapp.com/auth/getAllCreator");
...
const onDeleteUser = async (id) => {
    if (window.confirm("Ae you sure that you wanted to delete this user")){
        ...
        ('https://codeveloperslancini.herokuapp.com/auth/deleteCreator/${id}');
        if (response.status === 200){
